...
def gestion_lights_et_camera(Temps_total, frame_debut, duree_emission, frame_fin_animation):
    ...
    cmds.setKeyframe(renderCam, attribute='translateX', value=0.153, time = finAnim_plus_emission_2_85)
    cmds.setKeyframe(renderCam, attribute='translateY', value=7.147, time = finAnim_plus_emission_2_85)
    cmds.setKeyframe(renderCam, attribute='translateZ', value=0.444, time = finAnim_plus_emission_2_85)
    ...
    cmds.setKeyframe(renderCam, attribute='scaleX', value=3.5, time = finAnim_plus_emission_2_85)
    cmds.setKeyframe(renderCam, attribute='scaleY', value=3.5, time = finAnim_plus_emission_2_85)
    cmds.setKeyframe(renderCam, attribute='scaleZ', value=3.5, time = finAnim_plus_emission_2_85)
    ...
    cmds.setKeyframe(renderCam, attribute='translateX', value=138.077, time = debut_Matea)
    cmds.setKeyframe(renderCam, attribute='translateY', value=0.66, time = debut_Matea)
    cmds.setKeyframe(renderCam, attribute='translateZ', value=-383.066, time = debut_Matea)
    cmds.setKeyframe(renderCam, attribute='rotateX', value=-0.6, time = debut_Matea)
    cmds.setKeyframe(renderCam, attribute='rotateY', value=58.8, time = debut_Matea)
    cmds.setKeyframe(renderCam, attribute='rotateZ', value=0, time = debut_Matea)
    ...
    # Travelling de 100 frames
    matea100 = debut_Matea + 100
    cmds.setKeyframe(renderCam, attribute='translateX', value=137.915, time = matea100)
    cmds.setKeyframe(renderCam, attribute='translateY', value=0.658, time = matea100)
    cmds.setKeyframe(renderCam, attribute='translateZ', value=-383.164, time = matea100)
